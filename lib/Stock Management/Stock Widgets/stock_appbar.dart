...
import 'package:gtel_erp/Stock%20Management/ongoining_shipment_page.dart';
    ...
    return [
      PopupMenuButton<String>(
        ...
        onSelected: (value) {
          ...
          if (value == 'refresh') controller.refreshStockData();
        ...
        itemBuilder:
            (_) => const [
              ...
              PopupMenuItem(
                value: 'clear',
                child: ListTile(
                  leading: Icon(Icons.filter_alt_off, color: Colors.blueGrey),
                  title: Text('Clear Filters', style: TextStyle(fontSize: 13)),
                  contentPadding: EdgeInsets.zero,
                ),
              ),
              PopupMenuItem(
    ...
    return [
      ...
      Obx(() {
        return IconButton(
          ...
          tooltip: 'Refresh',
          onPressed:
              controller.isLoading.value ? null : controller.refreshStockData,
        );
      }),
